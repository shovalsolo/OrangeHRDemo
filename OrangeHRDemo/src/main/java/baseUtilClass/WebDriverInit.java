...
public class WebDriverInit {
	...
	private static WebDriverInit instanceDriver = null;							//Creating an object parameter of the class
	private WebDriver driver;
	public String projectPath = System.getProperty("user.dir");					//Creating a parameter of the path to the firefox driver

	private WebDriverInit() {													//Empty Constructor without Initializing
	}
	...
	public static WebDriverInit getInstance() {										//Get instance method
		if (instanceDriver == null)													//If instanceDriver is null empty
			instanceDriver = new WebDriverInit();									//Initializing instanceDriver with the object of DriverInit
